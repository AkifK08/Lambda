...
const DEPARTMENT_SLOT = {
  OWNER_OR_DEVELOPER: "Owner or Developer",
  GENERAL_CONTRACTOR: "General Contractor",
  SPECIALITY_CONTRACTOR: "Speciality Contractor",
  GOVERNMENT_OTHER:"Government Other"
};

/*ACTIONS THAT A USER CAN TAKE */
const ACTIONS = {
  TEST_INTERACTIVE: "Talk to Sales",
  Meeting: "Schedule a Demo",
  CONTINUE_TO_AGENT: "IFieldSmart Support",
  END_CHAT: "End chat",
};
...
const TEST_INTERACTIVE_OPTIONS_TEMPLATES = {
  ...
  DEPARTMENT_LISTPICKER: {
    ...
    data: {
      content: {
        title: "To recommend the right solution,which of the following pertains to you?.",
        subtitle: "",
        elements: [
          {
            title: DEPARTMENT_SLOT.OWNER_OR_DEVELOPER,
            // subtitle: "For billing issues",
          },
          {
            title: DEPARTMENT_SLOT.GENERAL_CONTRACTOR,
            // subtitle: "For new service",
          },
          {
            title: DEPARTMENT_SLOT.SPECIALITY_CONTRACTOR,
            // subtitle: "For new service requests",
          },
          {
            title: DEPARTMENT_SLOT.GOVERNMENT_OTHER,
            // subtitle: "For new service requests",
          },
        ],
      },
